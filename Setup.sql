...
tool_resources:
  ...
  deploy_html_report:
    identifier: "CORPORATE_REPORT_ANALYZE.REPORT_SEARCH_SCHEMA.DEPLOY_HTML_REPORT(VARCHAR, VARCHAR, VARCHAR)"
    type: "function"
...
GRANT USAGE ON PROCEDURE CORPORATE_REPORT_ANALYZE.REPORT_SEARCH_SCHEMA.DEPLOY_HTML_REPORT(VARCHAR, VARCHAR, VARCHAR) TO ROLE SYSADMIN;